function [tabInfectedCells,imgInfectionGlobal,imgInfectionGlobalHigh,propROI_infection]=findInfectedCells_global(imgRFP,mskCell,limAreaInf,valThld)
%% find infected cells based on intensity thresholding resulting by previous 
%% kmeans segmentation on RFP fluo (SPP1 DNA)
%% Outputs:
...
imgInfectionGlobal=1+(mskCell>0);% get areas associated to background and cells
imgInfectionGlobal(imgInfection>valThld)=3; % get areas with high intensity resulting SPP1 DNA
